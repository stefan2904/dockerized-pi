/**
 * Files Extension by @badlogic
 * added 2026-02-03 from https://github.com/badlogic/pi-mono/blob/c983bfdb1e33522d3f11d61405c63735251139cc/.pi/extensions/files.ts
 *
 * /files-changed command lists all files the model has read/written/edited in the active session branch,
